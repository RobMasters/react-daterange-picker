...
var DateRangePicker = _react2.default.createClass({
  ...
  renderCalendar: function renderCalendar(index) {
    ...
    var isRangeVisible = function isRangeVisible(range) {
      return monthRange.overlaps(range) || monthRange.end.isSame(range.start) || monthRange.start.isSame(range.end);
    };
    ...
    } else if ((0, _isMomentRange2.default)(value) && !isRangeVisible(value)) {
      value = null;
    }
    ...
    if (!(0, _isMomentRange2.default)(highlightedRange) || !isRangeVisible(highlightedRange)) {
      highlightedRange = null;
    }
